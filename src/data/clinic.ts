...
export const clinic = {
  ...
  description:
    '경기 화성시 동탄에 위치한 시호한의원입니다. 한방내과 전문의와 진료원장 2인이 진료합니다. 추나, 도침, 약침, 매선 치료와 자율신경실조·번아웃·이명·불면·소화불량 진료, 수험생·피부미용·다이어트·체형교정 클리닉을 운영합니다.',
  // 검색결과에 표시되는 meta description용. 네이버가 80자 이내를 권고합니다.
  metaDescription:
    '경기 화성시 동탄 시호한의원. 자율신경·불면·이명·통증 진료와 추나·약침·매선, 수험생·피부미용 클리닉을 운영합니다.',
  phone: '031-376-1505',
