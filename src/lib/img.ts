...
export const photos = {
  ...
  /*
   * 붉은 공진단 케이스(product-gongjindan-red)와 검정 경옥고 케이스
   * (product-gyeongokgo-black)는 더 이상 쓰지 않아 내렸습니다
   * (원장 확인, 2026-09). 다시 올리지 마세요.
   */
  /**
   * 공진단 선물 포장 — 공진단 안내.
   * 원장이 미리캔버스에서 직접 만든 이미지입니다(원장 확인, 2026-09).
   * ⚠ 상자에 인쇄된 중국어 문구('건강은 인생 최고의 선물' 등)를 alt 나
   *    본문으로 옮겨 적지 마세요. 사진 속 글자와 달리 사이트가 직접
   *    하는 주장이 됩니다(의료법 제56조).
   */
